---
title: React 中的数据结构(最小堆)
date: '2023-7-6'
tags: ['React']
draft: false
summary: 'react 源码最小堆数据结构的使用.'
authors: ['default']
---
...
![](https://xiejie-typora.oss-cn-chengdu.aliyuncs.com/2022-12-30-055103.png)
...
![](https://xiejie-typora.oss-cn-chengdu.aliyuncs.com/2022-12-30-055856.png)
...
![](https://xiejie-typora.oss-cn-chengdu.aliyuncs.com/2022-12-30-060219.png)

最小堆示例：

![](https://xiejie-typora.oss-cn-chengdu.aliyuncs.com/2022-12-30-060339.png)

- 无论是最大堆还是最小堆，第一个节点一定是这个堆中最大的或者最小的
- 每一层并非是按照一定顺序来排列的，比如下面的例子，6 可以在左分支，3 可以在右分支

![](https://xiejie-typora.oss-cn-chengdu.aliyuncs.com/2022-12-30-060935.png)
...
![](https://xiejie-typora.oss-cn-chengdu.aliyuncs.com/2022-12-30-061555.png)
...
![](https://xiejie-typora.oss-cn-chengdu.aliyuncs.com/2022-12-30-062926.png)
...
![](https://xiejie-typora.oss-cn-chengdu.aliyuncs.com/2022-12-30-064713.png)
